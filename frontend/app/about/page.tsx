...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-apple-surface-black py-12 md:py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto text-center mb-20">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white tracking-tight mb-6">
